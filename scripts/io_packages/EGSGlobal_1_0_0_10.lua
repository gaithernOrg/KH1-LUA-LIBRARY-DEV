...
synthItemSelected = 0x2E9A918

-- atlantica clams in battle and locking
evdlPointer = 0x234F188
...
-- current hits
currentHits = 0x296BC21

-- summon time
summonTime = 0x287131

-- interaction
chests_interaction = 0x2B3904
...
-- Assembly things
mainLoopSentinel = 0x288708
codeCave = 0x3B0150
codeCaveSize = 3736
assemblyMainLoopCodeCaveCall = {0xE8, 0x4B, 0x7A, 0x12, 0x00, 0xC3, 0xCC, 0xCC} -- Call code cave then return
assemblyMainLoopRestore = {0xC3, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC} -- Just return
assemblyPlaySE2 = {
    0x48, 0x83, 0xEC, 0x20,        -- sub rsp, 0x20
    0xB9, 0x1F, 0x00, 0x00, 0x00,  -- mov ecx, 0x1F (sound ID)
    0x31, 0xD2,                    -- xor edx, edx
    0xE8, 0x8C, 0x65, 0xDC, 0xFF,  -- call function to play SE2
