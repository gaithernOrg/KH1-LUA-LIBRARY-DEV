...
-- Assembly things
mainLoopSentinel = 0x28A888
codeCave = 0x3AF150
codeCaveSize = 3736
assemblyMainLoopCodeCaveCall = {0xE8, 0xCB, 0x48, 0x12, 0x00, 0xC3, 0xCC, 0xCC} -- Call code cave then return
...
assemblyPlaySE2 = {
    ...
    0xE8, 0x70, 0x96, 0xDC, 0xFF,  -- call function to play SE2
